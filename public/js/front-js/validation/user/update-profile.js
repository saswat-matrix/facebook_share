                ...
                const fv = FormValidation.formValidation(formAuthentication, {
                    fields: {
                        ...
                        work_tel: {
                            validators: {
                                /*notEmpty: {
                                    message: $('#js_validation_work_tel_notEmpty').val()
                                },*/
                                digits: {
                                    message: $('#js_validation_work_tel_digits').val()
                                },
                                stringLength: {
                                    min: 6,
                                    max: 14,
                                    message: $('#js_validation_work_tel_stringLength').val()
                                }
                            }
                        },
                        address: {
                        ...
                        company: {
                            validators: {
                                stringLength: {
                                    min: 2,
                                    max: 255,
                                    message: $('#js_validation_company_stringLength').val()
                                }
                            }
                        },
                        po_box: {
                            validators: {
                                stringLength: {
                                    min: 2,
                                    max: 255,
                                    message: $('#js_validation_po_box_stringLength').val()
                                }
                            }
                        },
                        citizenship_id: {
