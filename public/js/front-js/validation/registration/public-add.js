            ...
            $.ajax({
                ...
                success     : function (data) {
                    ...
                    if(typeof responseData.id !== null && typeof responseData.id !== undefined
                      ...
                      window.location.href = url + '/public-add-ajax-return?status=' + encodeURIComponent(status) + '&message=' + encodeURIComponent(message) + '&id=' + encodeURIComponent(responseData.id);
                    } else {
                      window.location.href = url + '/public-add-ajax-return?status=' + encodeURIComponent(status) + '&message=' + encodeURIComponent(message);
                    }
                },
