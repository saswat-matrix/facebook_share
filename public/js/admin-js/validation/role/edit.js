$(document).ready(function(){
    $('#selectAll_edit').on('click', function(){
        if($(this).prop('checked') === true) {
            $('[id^="editPermission__"]').prop('checked' , true);
        } else if($(this).prop('checked') === false) {
            $('[id^="editPermission__"]').prop('checked' , false);
        }
    })
});
...
if(FormValidation.formValidation){
    ...
    'use strict';
    const formAuthentication = document.querySelector('#editRoleForm');
