      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output = '<a href="' + $baseURL + 'console/invoice/detail">#' + $invoice_id + '</a>';
            return $row_output;
          }
        },
        {
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<a href="javascript:void(0);" class="text-body text-truncate fw-semibold">' +
              $name +
              '</a>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="' + $baseURL + 'console/invoice/detail" data-bs-toggle="tooltip" class="text-body" data-bs-placement="top" title="Preview Invoice"><i class="bx bx-show mx-1"></i></a>' +
              '<div class="dropdown">' +
              ...
              '<a href="' + $baseURL + 'console/invoice/edit" class="dropdown-item">Edit</a>' +
