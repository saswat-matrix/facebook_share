...
return new class extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::connection($this->connection)
                ->table('registrations', function (Blueprint $collection) 
                {
                    ...
                    $collection->string('unique_registration_form_id', 255)->nullable();
                    $collection->string('student_id', 255)->nullable();
                    $collection->string('student_registration_id', 255)->nullable();
                    $collection->enum('type', [Globals::REGISTRATION_TYPE_PUBLIC, Globals::REGISTRATION_TYPE_PARENT_USER, Globals::REGISTRATION_TYPE_ADMIN])->nullable()->comment(Globals::REGISTRATION_TYPE_PUBLIC . " => public, " . Globals::REGISTRATION_TYPE_PARENT_USER . " => parent user, " . Globals::REGISTRATION_TYPE_ADMIN . " => admin panel / backend"); // added on Date - Jan 29, 2024:
