    ...
    public function up()
    {
        ...
        Schema::connection($this->connection)
                ->table('students', function (Blueprint $collection) 
                {
                    ...
                    $collection->enum('gender', ['m', 'f', 't'])->default('m')->comment("m => male, f => female, t => third gender");
                    $collection->string('nationality')->nullable();
                    $collection->string('religion')->nullable();
                    $collection->enum('has_sibling', [Globals::SMALL_CHAR_YES, Globals::SMALL_CHAR_NO])->default(Globals::SMALL_CHAR_NO)->comment(Globals::SMALL_CHAR_YES . " => yes, " . Globals::SMALL_CHAR_NO . " => no");
                    ...
                    $collection->string('father_citizenship_id', 20)->nullable();
                    ...
                    $collection->string('mother_citizenship_id', 20)->nullable();
                    ...
                    //$collection->string('ec1_relationship_with_parents', 255)->nullable();               // added on 21-11-2024
                    $collection->string('ec1_phone_code', 20)->nullable();                             // added on 21-11-2024
                    $collection->string('ec1_country_code_iso2', 5)->nullable();                       // added on 21-11-2024 
                    $collection->string('ec1_country_code_iso3', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ec1_mobile', 20)->nullable();
                    $collection->string('ec1_phone', 20)->nullable();                                  // added on 21-11-2024
                    ...
                    //$collection->string('ec2_relationship_with_parents', 255)->nullable();               // added on 21-11-2024
                    $collection->string('ec2_phone_code', 20)->nullable();                             // added on 21-11-2024
                    $collection->string('ec2_country_code_iso2', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ec2_country_code_iso3', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ec2_mobile', 20)->nullable();
                    $collection->string('ec2_phone', 20)->nullable();                                  // added on 21-11-2024
                    ...
                    $collection->string('ap1_phone_code', 20)->nullable();                             // added on 21-11-2024
                    $collection->string('ap1_country_code_iso2', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ap1_country_code_iso3', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ap1_mobile', 20)->nullable();
                    $collection->string('ap1_phone', 20)->nullable();                                  // added on 21-11-2024
                    $collection->string('ap1_citizenship_id', 255)->nullable();                        // added on 21-11-2024
                    ...
                    $collection->string('ap2_phone_code', 20)->nullable();                             // added on 21-11-2024
                    $collection->string('ap2_country_code_iso2', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ap2_country_code_iso3', 5)->nullable();                       // added on 21-11-2024
                    $collection->string('ap2_mobile', 20)->nullable();
                    $collection->string('ap2_phone', 20)->nullable();                                  // added on 21-11-2024
                    $collection->string('ap2_citizenship_id', 255)->nullable();                        // added on 21-11-2024
                    ...
                    $collection->string('registration_id', 255)->nullable();
                    $collection->string('student_registration_id', 255)->nullable();
                    $collection->enum('registration_type', [Globals::REGISTRATION_TYPE_PUBLIC, Globals::REGISTRATION_TYPE_ADMIN])->nullable()->comment(Globals::REGISTRATION_TYPE_PUBLIC . " => public, " . Globals::REGISTRATION_TYPE_ADMIN . " => admin panel / backend"); // added on Date - Jan 29, 2024:                    
        ...
        /*Schema::connection($this->connection)
                ->table('student_services', function (Blueprint $collection) 
                {
                    // student basic detail //
                    $collection->index('_id');
                    ...
                    // student's service //
                    $collection->dateTime('lunch_effective_starting')->nullable();
                    $collection->array('lunch_terms')->nullable();
                    $collection->array('lunch_days')->nullable();
                    $collection->string('food_allergy_comment', 255)->nullable();
                    $collection->string('special_diet_comment', 255)->nullable();
                    $collection->enum('vegetarian_alternative', [Globals::SMALL_CHAR_YES, Globals::SMALL_CHAR_NO])->default(Globals::SMALL_CHAR_NO)->comment(Globals::SMALL_CHAR_YES . " => yes, " . Globals::SMALL_CHAR_NO . " => no");

                    $collection->dateTime('transport_effective_starting')->nullable();
                    $collection->enum('transport_type', ['p', 'd', 't'])->comment("p => pick up, d => drop off, t => two-ways")->nullable();
                    $collection->string('transport_area', 255)->nullable();
                    $collection->string('transport_street_name', 255)->nullable();
                    $collection->string('transport_building_name', 255)->nullable();
                    $collection->string('transport_comment', 255)->nullable();

                    $collection->string('student_id', 255);
                    $collection->string('created_by')->nullable();
                    $collection->dateTime('created_at');
                    $collection->dateTime('updated_at');
                    $collection->dateTime('deleted_at')->nullable();
        ...
        Schema::connection($this->connection)
                ->table('student_lunches', function (Blueprint $collection) 
                {
                    $collection->index('_id');
                    $collection->string('year_id', 255)->nullable();
                    $collection->string('year', 255)->nullable();
                    $collection->string('term_id', 255)->nullable();
                    $collection->string('term', 255)->nullable();
                    $collection->dateTime('effective_starting')->nullable();
                    $collection->array('days')->nullable();
                    $collection->string('food_allergy_comment', 255)->nullable();
                    $collection->string('special_diet_comment', 255)->nullable();
                    $collection->enum('vegetarian_alternative', [Globals::SMALL_CHAR_YES, Globals::SMALL_CHAR_NO])->default(Globals::SMALL_CHAR_NO)->comment(Globals::SMALL_CHAR_YES . " => yes, " . Globals::SMALL_CHAR_NO . " => no");
                    $collection->string('enrolment_id', 255)->nullable();
        ...
        Schema::connection($this->connection)
                ->table('student_transports', function (Blueprint $collection) 
                {
                    // student basic detail //
                    $collection->index('_id');
                    $collection->string('year_id', 255)->nullable();
                    ...
                    $collection->string('term', 255)->nullable();
                    $collection->dateTime('effective_starting')->nullable();
                    $collection->enum('type', [Globals::TRANSPORT_TYPE_PICK_UP, Globals::TRANSPORT_TYPE_DROP_OFF, Globals::TRANSPORT_TYPE_TWO_WAYS])->comment(Globals::TRANSPORT_TYPE_PICK_UP . " => pick up, " . Globals::TRANSPORT_TYPE_DROP_OFF . " => drop off, " . Globals::TRANSPORT_TYPE_TWO_WAYS . " => two-ways")->nullable();
                    $collection->string('area', 255)->nullable();
                    $collection->string('street_name', 255)->nullable();
                    $collection->string('building_name', 255)->nullable();
                    $collection->string('comment', 255)->nullable();
                    $collection->string('enrolment_id', 255)->nullable();
                    $collection->string('student_id', 255)->nullable();
                    $collection->string('student_enrolment_id', 255)->nullable();
                    $collection->string('invoice_id', 255)->nullable();
        ...
        Schema::connection($this->connection)
                ->table('student_classes', function (Blueprint $collection) 
                {
                    // student basic detail //
                    $collection->index('_id');
                    $collection->string('year_id', 255);
                    $collection->string('year', 255);
                    $collection->string('term_id', 255);
                    $collection->string('term', 255);
                    $collection->string('class_id', 255);
                    $collection->array('curriculums')->nullable();
                    $collection->array('days')->nullable();
                    $collection->string('timing_id', 255);
                    ...
                    $collection->dateTime('joining_date')->nullable();
                    $collection->string('enrolment_id', 255)->nullable();
                    $collection->string('student_id', 255);
                    $collection->string('student_enrolment_id', 255)->nullable();
                    $collection->string('invoice_id', 255);
                    $collection->enum('current', [Globals::SMALL_CHAR_YES, Globals::SMALL_CHAR_NO])->default(Globals::SMALL_CHAR_NO)->comment(Globals::SMALL_CHAR_YES . " => yes, " . Globals::SMALL_CHAR_NO . " => no");
                    $collection->string('created_by')->nullable();
                    $collection->dateTime('created_at');
                    $collection->dateTime('updated_at');
        ...
        Schema::connection($this->connection)
                ->table('student_action_histories', function (Blueprint $collection) 
                {
                    $collection->index('_id');
                    $collection->string('action', 255);
                    $collection->string('student_id', 255);
                    $collection->string('created_by')->nullable();
                    $collection->dateTime('created_at');
                    $collection->dateTime('updated_at');
        ...
        Schema::connection($this->connection)
                ->table('student_activities', function (Blueprint $collection) 
                {
                    // student basic detail //
                    $collection->index('_id');
                    $collection->string('year', 255);
                    $collection->string('term', 255);
                    $collection->string('class', 255);
                    $collection->dateTime('effective_starting')->nullable();
                    $collection->string('activity_id', 255);
                    $collection->string('enrolment_id', 255)->nullable();
                    $collection->string('student_id', 255);
                    $collection->string('student_enrolment_id', 255)->nullable();
                    $collection->enum('current', [Globals::SMALL_CHAR_YES, Globals::SMALL_CHAR_NO])->default(Globals::SMALL_CHAR_NO)->comment(Globals::SMALL_CHAR_YES . " => yes, " . Globals::SMALL_CHAR_NO . " => no");
        ...
        Schema::connection($this->connection)
                ->table('student_documents', function (Blueprint $collection) 
                {
                    // student basic detail //
                    $collection->index('_id');
